...
from utils.tools import ImageList, CalcTopMap
...
if __name__ == '__main__':
    ...
    dset = "CASIA"
    # 加载测试集
    ########### 试一下改transform 哪个效果好点
    data_path = '/data/UTAH_code/UTAP/UTAP/save_img/adv_Vgg16/WeChat'
    list_path = '/data/UTAH_code/UTAP/UTAP/save_img/train_0_jpg.txt'
    ...
    for m in range(1):
        ...
        print("mAP:" + str(org_mAP) + "->" + str(per_mAP))
